...
const SVGRemote: FunctionComponent<Props> = (props) => {
  const { src, size, alt, className, placeholderSrc, ...svgProps } = props
  ...
  return (
    <ReactInlineSVG cacheRequests {...svgProps} src={source} className={className} width={width} height={height}>
